...
ほかに、ダッシュボードにはいま作業中のタスクが、開始した時刻と経過時間つきで並びます（「10:42 から (2時間5分)」。前日以前に開始したものは日付も付く）。中断の押し忘れもここで気づけます。また、Weekly Review からはレビュー当日より前の7日間の各日の作業記録を開けます。「先週完了したもの」と同じ7日間です。
